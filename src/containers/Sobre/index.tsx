...
const Sobre = () => (
  <section>
    ...
    <Paragrafo tipo="secundario">
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime vel, ex
      quis rerum nesciunt facilis placeat quasi, quidem totam, blanditiis
      exercitationem quia nostrum quos vero accusamus sit mollitia in. Dolore.
    </Paragrafo>
    <GithubSecao>
